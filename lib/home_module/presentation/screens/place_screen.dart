...
import 'package:project1/home_module/presentation/screens/occupations_screen.dart';
import 'package:project1/login_module/presentation/component/component.dart';
import 'package:sizer/sizer.dart';

late String idPlace2;
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: MaterialButton(
                                          onPressed: () {
                                            namePlace=HomeCubit.get(context).place!.data[index].name!;
                                            idPlace2 = HomeCubit.get(context).place!.data[index].id!;
                                            HomeCubit.get(context).getOccupation(
                              ...
                              child: MaterialButton(
                                onPressed: () {
                                  if (formKey.currentState!.validate()) {
                                    HomeCubit.get(context).insertPlace(name: place.text, idRegion: idRegion2);
                                    place.text = '';
                                  }
                                },
                                child: Text(
